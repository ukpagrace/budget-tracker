    ...
    <div className="container">
        ...
        <Card className="col-span-12 mt-2 w-full">
            <CardHeader className="gap-2">
                <CardTitle className="grid grid-flow-row justify-between
                ...
                <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                    ...
                    {!dataAvailable &&  (
                        <Card className="flex h-[300px] flex-col items-center justify-center bg-background">
                            No data for the selected period or adding new transactions
                        </Card>
                    )}
...
function TooltipRow({label, value, textColor, bgColor, formatter} : {
    label: string;
    textColor: string;
    bgColor: string;
    value: number;
